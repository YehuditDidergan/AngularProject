...
namespace RecipeApi.Controllers
{
    ...
    public class RecipeController : Controller
    {
        ...
        {   new Recipe(16, "IceStrawberry", 2, 2, 8, DateTime.Now, new List<string>() { "Strawberries", "Sugar", "Milk" }, new List<string>() { "Blend ingredients", "Pour into a cup", "Enjoy!" }, 3, "../../../assets/images/recipe-images/17.jpg"),
             ...
             new Recipe(1, "fgeg", 2, 2, 8, DateTime.Now, new List<string>() { "Strawberries", "Sugar", "Milk" }, new List<string>() { "Blend ingredients", "Pour into a cup", "Enjoy!" }, 4, "../../../assets/images/recipe-images/22.jpg"),
        ...
        public void PutById([FromBody] Recipe recipe, int id)
        {
            ...
            updateRecipe.UserId = recipe.UserId;
            updateRecipe.Date = recipe.Date;
            updateRecipe.Level = recipe.Level;
            updateRecipe.Img=recipe.Img;
            updateRecipe.Name=recipe.Name;
            updateRecipe.Ingredients=recipe.Ingredients;
            updateRecipe.Instructions=recipe.Instructions;
            updateRecipe.PreparationTime=recipe.PreparationTime;
